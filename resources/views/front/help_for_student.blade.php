<x-front-layout :title="label_text('global', 'site.Help For Student', __('site.Help For Student'))">
        ...
        <div class="container z-10 px-4 mx-auto w-full">
            <nav aria-label="Breadcrumb" class="mb-14">
                <ul class="flex items-center space-x-1 text-sm font-light">
                    ...
                    <li>
                        <span class="text-gray-900">{{ label_text('global', 'site.Help For Student', __('site.Help For Student')) }}</span>
                    </li>
                </ul>
            </nav>

            <h2 class="mb-2 text-3xl font-bold">{{ label_text('global', 'site.Help For Student', __('site.Help For Student')) }}</h2>
                    ...
                    @foreach ($articles as $article)
                        ...
                        <div
                            ...
                            <div class="p-8">
                                ...
                                <a href="{{ route('site.show_help', ['audience' => 'student', 'slug' => $article->slug]) }}"
