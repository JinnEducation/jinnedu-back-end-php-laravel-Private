        ...
        <div class="container z-10 px-4 mx-auto w-full">
            ...
            <nav aria-label="Breadcrumb" class="mb-14">
                <ul class="flex items-center space-x-1 text-sm font-light">
                    ...
                    <li>
                        <a href="{{route('site.blog')}}" class="transition-colors text-primary-600 hover:text-primary-700">Blog</a>
                    </li>
                    <li>
                        <span class="text-gray-400">
                            <i class="font-light fas fa-chevron-right"></i>
                        ...
                        <div
                            ...
                            <div class="overflow-hidden relative h-67 group">
                                <img src="{{ $course->image }}"
                                    alt="{{ $course->name }}" class="object-cover w-full h-full">
                                <div class="absolute right-2 top-4">
                                    <span class="px-4 py-2 text-base text-white rounded-xl bg-primary">Free Learn</span>
                                </div>
                                <div
                                    ...
                                    <div class="flex justify-center items-center h-full">
                                        <a href="#" class="px-8 py-4 text-lg text-white rounded-lg bg-primary">Load
                                            More</a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="py-2 mt-3 border-t border-[#E5E7EB]">
                                    <div class="flex justify-between items-center transition-all duration-300">
                                        <div class="flex gap-1 items-center">
                                            ...
                                            <span class="text-sm text-gray-400">level : {{ $course->lessons }}</span>
                                        </div>

                                        <div class="flex gap-1 items-center">
                                            <i class="text-lg fas fa-clock text-primary"></i>
                                            <span class="text-sm font-bold text-gray-400">{{ $course->class_length }} learning hours</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
