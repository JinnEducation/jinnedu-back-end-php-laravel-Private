                ...
                <div class="block overflow-hidden bg-white rounded-md shadow-lg transition-all duration-300 course-blogs-card hover:shadow-lg hover:scale-102"
                    ...
                    <div class="p-4 pb-0">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <a href="artical.html"
                                class="text-sm font-medium text-[#0553FC] underline hover:text-primary hover:mr-3 rtl:hover:ml-3 transition-all duration-300">Load
                                More</a>
                        </div>
                        <div class="py-2 mt-3 border-t border-[#E5E7EB]">
                            <div class="flex justify-between items-center transition-all duration-300">
                                ...
                                <div class="flex gap-1 items-center">
                                    ...
                                    <span class="text-sm text-gray-400">August 1, 2024</span>
                                </div>
                            </div>
                        </div>
                    </div>
