<x-front-layout>
    <div class="container mx-auto px-4 py-16">
        <div class="max-w-md mx-auto bg-white rounded-lg shadow-lg p-8 text-center">
            ...
            <h2 class="text-2xl font-bold mb-4 text-gray-800">Test Payment (Local Mode)</h2>
            <p class="mb-2 text-gray-600">This is a test payment page for development.</p>
            <p class="mb-6 text-lg font-semibold text-gray-800">Amount: ${{ number_format($transaction->amount, 2) }}</p>
            
            <div class="bg-gray-50 rounded-lg p-4 mb-6 text-left">
                <p class="text-sm text-gray-600 mb-2"><strong>Transaction ID:</strong> {{ $transaction->reference_id }}</p>
                <p class="text-sm text-gray-600 mb-2"><strong>Payment Channel:</strong> {{ $transaction->payment_channel }}</p>
                <p class="text-sm text-gray-600"><strong>Current Wallet:</strong> ${{ number_format($transaction->current_wallet, 2) }}</p>
            </div>
