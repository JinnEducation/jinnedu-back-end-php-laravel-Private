...
class UserController extends Controller
{
    ...
    public function tutorsSearch(Request $request)
    {
        ...
        switch ($request->sort_by) {
            case 'full_name_asc':
                $items->orderBy('full_name', 'ASC');
                break;
            case 'full_name_desc':
                $items->orderBy('full_name', 'DESC');
                break;
            case 'price_asc':
    ...
    public function tutorFavorite(Request $request)
    {
        ...
        $favorites = UserFavorite::with('tutor', 'course.langs', 'group_class.langs', 'group_class.imageInfo')->where('user_id', $user->id)->orderBy('id', 'desc')->get();
