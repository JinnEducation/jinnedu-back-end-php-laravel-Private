...
return [
    ...
    'Help For Student' => 'مساعدة للطالب',
...
conditions and the privacy policy of the Jien platform.' => 'بالنقر على إتمام الشراء، أقر بأنني قرأت ووافقت على الشروط والأحكام وسياسة الخصوصية الخاصة بمنصة جين.',
    ...
    'Help' => 'المساعدة',
    'Help Type' => 'نوع المساعدة',
    'Explore Help Articles' => 'استكشف مقالات المساعدة',
    'No help articles available at the moment.' => 'لا توجد مقالات مساعدة متاحة حالياً.',
    'Your Rating' => 'تقييمك',
    'No FAQs available at the moment.' => 'لا توجد أسئلة شائعة متاحة حالياً.',
    ...
    'Top-up-your-wallet' => 'قم بتعبئة محفظتك في خطوتين: 1) أدخل المبلغ 2) اختر بوابة الدفع.',
    'Complete-your-payment' => 'أكمل دفعتك: 1) مراجعة العناصر 2) اختر طريقة الدفع.',

    'no_orders_found' => '⚠️ لم يتم العثور على طلبات أو أن الطلبات مدفوعة بالفعل.',
    'requested_order_ids' => 'أرقام الطلبات المطلوبة',
    'check_order_or_support' => 'يرجى التحقق من حالة الطلب أو التواصل مع الدعم.',
    'total_amount' => 'المبلغ الإجمالي',
    'wallet_amount' => 'مبلغ المحفظة',
    'payment_data' => 'بيانات الدفع',
    'country' => 'الدولة',
    'purchase_confirmation' => 'تأكيد الشراء',
    'agree_terms' => 'بالنقر على إتمام الشراء، أقر بأنني قرأت ووافقت على الشروط والأحكام وسياسة الخصوصية الخاصة بمنصة جين.',
    'secure_transactions' => 'جميع المعاملات آمنة ويتم معالجتها واعتمادها من مزودي خدمات الدفع.',
    'price_variation_notice' => 'قد يختلف السعر المعروض في صفحة مزود الدفع قليلًا بسبب اختلاف أسعار الصرف.',
